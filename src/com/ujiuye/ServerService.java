 ...
 * 
 */
@WebServiceClient(name = "ServerService", targetNamespace = "http://ujiuye.com/", wsdlLocation = "http://localhost:9001/Service/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVERSERVICE_QNAME = new QName("http://ujiuye.com/", "ServerService");
    ...
    public Server getServerPort() {
        return super.getPort(new QName("http://ujiuye.com/", "ServerPort"), Server.class);
    }
    ...
    public Server getServerPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ujiuye.com/", "ServerPort"), Server.class, features);
    }
